    ...
    <div class="container-fulid">
        ...
        <div class="row align-items-end">
            ...
            <div class="col-12 col-sm-4">
                <a href="{{ $EPC->link_VDO }}" target="_blank"> <img src="{{ asset($EPC->image_VDO) }}" class="w-100 mt-5" alt=""></a>
            </div>
            <div class="col-12 col-sm-4 text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-3 text-center">
                        <img src="{{ asset($EPCHome->image_icon) }}" alt="">
                        </a>
                    </div>
                    <div class="col-12 col-lg-9">
                        <div class="card">
                            <div class="text1">{!!$EPC->sub_tilte_en !!}</div>
                            <h1 class="h1">{!! $EPC->tilte_en !!}</h1>
                            <p>{!! $EPC->detail_en !!}</p>
                        </div>
                    </div>
                    <div class="w-100"></div>
        ...
        <div class="content-ourbiz">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="card">
                            <div class="text1">{!!$EPC->sub_tilte_th !!}</div>
                            <h1 class="h1">{!! $EPC->tilte_th !!}</h1>
                            <p>{!! $EPC->detail_th !!}</p>
                        </div>
                    </div>
                    <div class="w-100"></div>
