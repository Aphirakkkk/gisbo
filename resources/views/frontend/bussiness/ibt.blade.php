    ...
    <div class="container-fulid">
        ...
        <div class="row align-items-end">
            <div class="col-12 col-sm-4 text-center">
                <a class="biz-pv" href="/business-enr">
                    <img src="img/biz-pv.png" alt="">
                    <span class="color2 h3">ENR</span>
                </a>
                <img src="img/product-content1-1.png" class="w-100" alt="">
            </div>
            <div class="col-12 col-sm-4">
                <a href="{{ $IBT->link_VDO }}" target="_blank"> <img src="{{ asset($IBT->image_VDO) }}" class="w-100 mt-5" alt=""></a>
            </div>
            <div class="col-12 col-sm-4 text-center">
                <a class="biz-next" href="/business-epc">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-3 text-center">
                        <img src="{{ asset($IBTHome->image_icon) }}" alt="">
                        </a>
                    </div>
                    <div class="col-12 col-lg-9">
                        <div class="card">
                            <div class="text1">{!!$IBT->sub_tilte_en !!}</div>
                            <h1 class="h1">{!! $IBT->tilte_en !!}</h1>
                            <p>{!! $IBT->detail_en !!}</p>
                        </div>
                    </div>
                    <div class="w-100"></div>
        ...
        <div class="content-ourbiz">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="card">
                            <div class="text1">{!!$IBT->sub_tilte_th !!}</div>
                            <h1 class="h1">{!! $IBT->tilte_th !!}</h1>
                            <p>{!! $IBT->detail_th !!}</p>
                        </div>
                    </div>
                    <div class="w-100"></div>
