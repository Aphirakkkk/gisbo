        ...
        <section class="project-section">
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    @foreach ($ProjectsReferenceMain as $key => $Image)
                    <li data-target="#carousel" data-slide-to="{{ $Image->id }}" class="{{ $loop->first ? 'active' : '' }}"></li>
                    @endforeach
                ...
                <div class="carousel-inner" role="listbox">
                    @foreach ($ProjectsReferenceMain as $key => $Image)
                    <div class="carousel-item {{ $loop->first ? 'active' : '' }}" style="background-image: url({{ asset($Image->image_main) }});">
                    </div>
                    @endforeach
                ...
                @foreach ($ProjectsReferenceMain as $key => $ProjectsReferenceMain)
