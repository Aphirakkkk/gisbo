                ...
                <div class="text-center mt-5 mb-4">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ $NewEventsMain->tilte_en }}</li>
                        </ol>
                    </nav>
                </div>
                <div class="newsDetail-content">
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-6">
                            ...
                            <h5 class="h5">
                                {{ $NewEventsMain->tilte_en }}
                            </h5>
                            <p>
                                <img src="{{ asset('img/calendar.png') }}" alt="" />&nbsp;&nbsp;
                                {{ $NewEventsMain->date }}
                            </p>
                            {!! $NewEventsMain->detail_en !!}
                            <br>
                            <a href="/#news" class="btn btn-second"><img src="{{ asset('img/pv-newxdetail.png') }}" alt=""> &nbsp; Back</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mt-5 mb-4">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Home</a></li>
                            <li class="breadcrumb-item"><a href="/#news">News & Events </a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ $NewEventsMain->tilte_th }}</li>
                        </ol>
                    </nav>
                </div>
                <div class="newsDetail-content">
