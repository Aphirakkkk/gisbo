...
<html lang="en">
    ...
    <body>
        ...
        <div id="aboutus-page" class="ethics">
            <!-- <img src="img/banner.jpg" alt=""> -->
            <div class="container-fulid">
                <div class="row">
                    <div class="col-12 pl-5 pl-sm-0">
                        <img src="img/about-line-1.png" alt="" />
                        ...
                        <div class="row">
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                        ...
                                        <div class="content-left">
                                            ...
                                            <div class="content-ethics">
                                                @if(isset($AboutUsEthicsList) && count($AboutUsEthicsList) > 0)
                                                    @foreach($AboutUsEthicsList as $key => $item)
                                                    @php $indexNum = $key + 1; @endphp
                                                    <div class="topic topic{{ $indexNum }}">
                                                        <h2 class="h2">
                                                    ...
                                                    <div class="detail detail{{ $indexNum }} mb-3">
                                                        @if(Config::get('app.locale') == 'en')
                                            ...
                                            <img src="{{ asset('img/People.png') }}" class="w-100 people-content-ethics" alt="">
                            ...
                            <div class="col-12 col-xl-3 d-none d-xl-block">
                                <div class="nav flex-column nav-pills" id="about-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link active" href="/about_ethics-detail"><img src="{{ asset('img/Ethics-icon-1.png') }}" alt="" /> Ethics</a>
