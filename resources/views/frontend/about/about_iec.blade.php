...
<html lang="en">
    ...
    <body>
        ...
        <div id="aboutus-page" class="ISO9001">
            <!-- <img src="img/banner.jpg" alt=""> -->
            <div class="container-fulid">
                <div class="row">
                    <div class="col-12">
                        <img class="about-line" src="img/about-line-1.png" alt="" />
                        <h1 class="h1 color1 text-uppercase my-3 pl-3 pt-sm-0">ISO / IEC</h1>
                    </div>

                    <div class="col-12 col-xl-12">
                        <div class="row">
                            <div class="col-12 col-sm-8 pl-4 pr-0">
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                        <div class="iso-slider-wrapper" id="isoIECSliderDetail">
                                            @if(count($AboutUsIECList) > 1)
                                            <button type="button" class="iso-nav-btn iso-btn-prev" onclick="changeIsoSlide('isoIECSliderDetail', -1)">
                                                    ...
                                                    <div class="iso-slide-item {{ $key == 0 ? 'active' : '' }}" data-slide-index="{{ $key }}">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-6 col-xl-5 mb-4">
                                                                <img class="w-100 shadow-sm border rounded" src="{{ asset($item->image1) }}" alt="ISO / IEC 27001" />
                                                            </div>
                                                            @endif
                                                            @if($item->image2 && $item->image2 != 'assets/backend/images/error/nopic.jpg')
                                                            <div class="col-12 col-lg-6 col-xl-5 mb-4">
                                                                <img class="w-100 shadow-sm border rounded" src="{{ asset($item->image2) }}" alt="ISO / IEC 27001 Page 2" />
                                                            </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                            ...
                                            @if(count($AboutUsIECList) > 1)
                                            <button type="button" class="iso-nav-btn iso-btn-next" onclick="changeIsoSlide('isoIECSliderDetail', 1)">
                            ...
                            <div class="col-12 col-xl-3 d-none d-xl-block">
                                <div class="nav flex-column nav-pills" id="about-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link active" href="/about_iec-detail"><img src="{{ asset('img/ISO9001-icon-1.png') }}" alt="" /> ISO / IEC 27001</a>
