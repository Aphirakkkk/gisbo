            ...
            <div class="container-fulid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h1 class="h1 color1 text-uppercase my-3 pl-3 pt-sm-0">Organizational STRUCTURE</h1>
                    </div>

                    <div class="col-12 col-xl-8 pl-4 pr-0">
                        <div class="tab-pane fade show active" id="v-OrganiztionalStructure-tab" role="tabpanel" aria-labelledby="v-pills-OrganiztionalStructure-tab">
                    ...
                    <div class="col-12 col-xl-3 d-none d-xl-block">
                        <div class="nav flex-column nav-pills" id="about-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link active" href="/about_organiztional-detail"><img src="{{ asset('img/Organiztional-Structure-icon-1.png') }}" alt="" /> Organizational Structure</a>
