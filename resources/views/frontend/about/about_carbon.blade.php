                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-3 d-none d-xl-block">
                                ...
                                <div class="nav flex-column nav-pills" id="about-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link active" href="/about_carbon-detail"><img src="{{ asset('img/Carbon-icon.PNG') }}" alt="" style="width: 28px; height: 28px; object-fit: contain; margin-right: 10px;" /> Carbon Footprint</a>
