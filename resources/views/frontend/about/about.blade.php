...
<html lang="en">
    ...
    <body>
        ...
        <div id="aboutus-page" class="aboutpage">
            ...
            <div class="container-fulid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h1 class="h1 color1 text-uppercase my-3 pl-3 pt-sm-0">About Gis group</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-8 pl-4 pr-0">
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                        ...
                                        @if(isset($about_us_main))
                                            @if($about_us_main->image_main && $about_us_main->image_main != 'assets/backend/images/error/nopic.jpg')
                                            <div class="img-content mb-4">
                                                <img class="w-100 rounded shadow-sm" src="{{ asset($about_us_main->image_main) }}" alt="About Us" />
                                            </div>
                                            @endif

                                            <div class="content-left">
                                                @if(Config::get('app.locale') == 'en')
                                                    {!! $about_us_main->detail_en ?: $about_us_main->detail_th !!}
                                                @else
                                                    {!! $about_us_main->detail_th ?: $about_us_main->detail_en !!}
                                                @endif
                                            </div>
                                        @endif
                                    ...
                                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                        ...
                                        <div class="content-about">
                                            ...
                                            <img class="w-100" src="{{ asset('img/about-home.png') }}" alt="" />
                            ...
                            <div class="col-12 col-xl-3 d-none d-xl-block">
                                ...
                                <div class="nav flex-column nav-pills" id="about-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link active" href="/about-detail"><img src="{{ asset('img/about-icon-1.png') }}" alt="" /> About Us</a>
