...
<html lang="en">
    ...
    <body>
        ...
        <div id="aboutus-page" class="value">
            <!-- <img src="img/banner.jpg" alt=""> -->
            <div class="container-fulid">
                <div class="row">
                    <div class="col-12">
                        <img class="about-line" src="img/about-line-1.png" alt="" />
                        <h1 class="h1 color1 text-uppercase my-3 pl-3 pt-sm-0">Values Statement</h1>
                    </div>

                    <div class="col-12 col-xl-12">
                        <div class="row">
                            <div class="col-12 col-sm-9 pl-4 pr-0">
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">

                                        <div class="row">
                                            @if(isset($AboutUsValuesList) && count($AboutUsValuesList) > 0)
                                                @foreach($AboutUsValuesList as $key => $item)
                                                <div class="col-12 col-md-6 col-lg-4 mb-4">
                                                    <div class="value-gis h-100">
                                                        @if($item->image_main && $item->image_main != 'assets/backend/images/error/nopic.jpg')
                                                            <img src="{{ asset($item->image_main) }}" class="w-100 mb-3" alt="{{ $item->tilte_th ?: $item->tilte_en }}">
                                                        @endif
                                                        <div class="topic topic1">
                                                            <h2 class="h2">
                                                                @if(Config::get('app.locale') == 'en')
                                                                    {!! $item->tilte_en ?: $item->tilte_th !!}
                                                                @else
                                                                    {!! $item->tilte_th ?: $item->tilte_en !!}
                                                                @endif
                                                            </h2>
                                                        </div>
                                                        <div class="detail-text">
                                                            @if(Config::get('app.locale') == 'en')
                                                                {!! $item->detail_en ?: $item->detail_th !!}
                                                            @else
                                                                {!! $item->detail_th ?: $item->detail_en !!}
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-12 col-xl-3 d-none d-xl-block">
                                <div class="nav flex-column nav-pills" id="about-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link active" href="/about_values-detail"><img src="{{ asset('img/Values-icon-1.png') }}" alt="" /> Values</a>
