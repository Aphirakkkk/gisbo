                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-9 pl-4 pr-0">
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <span>
                                                            ...
                                                            <img src="{{ asset('img/why-icon.png') }}" alt="" width="40">
                                        ...
                                        <div class="content-left2 d-none d-xl-block">
                            ...
                            <div class="col-12 col-xl-3 d-none d-xl-block">
                                ...
                                <div class="nav flex-column nav-pills" id="about-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link" href="/about_why-detail"><img src="{{ asset('img/WhyChoose-icon-1.png') }}" alt="" /> WhyChoose   </a>
                                    ...
                                    <a class="nav-link" id="v-pills-Policy-tab" data-toggle="pill"
                                        href="#v-pills-Policy" role="tab" aria-controls="v-pills-Policy" aria-selected="false">
                                            <img src="img/policy-icon.PNG" alt="Policy Icon" width="35" height="35" /> Policy
                                        </a>    
                                        ...
                                        href="#v-pills-Carbon" role="tab" aria-controls="v-pills-Carbon" aria-selected="false">
                                            <img src="img/Carbon-icon.PNG" alt="Carbon Footprint Icon" width="35" height="35" /> Car        bon Footprint
                                        </a>
