            ...
            <div class="container-fulid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h1 class="h1 color1 text-uppercase my-3 pl-3 pt-sm-0">ISO 45001</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-8 pl-4 pr-0">
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                        <div class="iso-slider-wrapper" id="iso45001SliderDetail">
                                            @if(count($AboutUs45001List) > 1)
                                            <button type="button" class="iso-nav-btn iso-btn-prev" onclick="changeIsoSlide('iso45001SliderDetail', -1)">
                                            ...
                                            @if(count($AboutUs45001List) > 1)
                                            <button type="button" class="iso-nav-btn iso-btn-next" onclick="changeIsoSlide('iso45001SliderDetail', 1)">
                            ...
                            <div class="col-12 col-xl-3 d-none d-xl-block">
                                <div class="nav flex-column nav-pills" id="about-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link active" href="/about_45001-detail"><img src="{{ asset('img/ISO9001-icon-1.png') }}" alt="" /> ISO 45001</a>
