...
<div class="card cardboby">
    ...
    <div class="card-body">
        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('aboutus45001.store') }}">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label font-weight-bold">
                            รูปภาพใบรับรอง ISO 45001 (หน้าที่ 1) <span class="text-danger">*</span>
                        </label>
