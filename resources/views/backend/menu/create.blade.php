...
<div class="card cardboby">
    ...
    <div class="card-body">
        <form class="from-horizontal" method="post" enctype="multipart/form-data" action="{{ route('menu.store') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 ">
                    <input type="text" class="form-control" name="tilte_th" placeholder="กรอกชื่อเมนูหลัก ภาษาไทย" autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                <label for="m" class="col-sm-12 control-label TilteInput">ชื่อเมนูหลัก ภาษาอังกฤษ</label>
                <div class="col-sm-12 ">
                    <input type="text" class="form-control" name="tilte_en" placeholder="กรอกชื่อเมนูหลัก ภาษาอังกฤษ" autocomplete="off">
                </div>
            </div>
            <hr>
