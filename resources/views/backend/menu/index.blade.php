...
<div class="card cardboby">
    <form action="{{ route('menu.index') }}" method="GET" onsubmit="return checkdate()">
        <div class="container-fluid mt-4">
            <div class="row">
                ...
                {{-- <div class="text-right col-md-2">
                    <br />
                    <a class="mt-2 ml-0 btn w-100 btn-outline-success" href="{{ route('menu.create') }}">เพิ่มข้อมูล</a>
            </div> --}}
        </div>
</div>
</form>
    ...
    <table id="example" class="table table-dark table-bordered table-striped no-wrap responsive">
        ...
        <tbody>
            ...
            <tr class="text-center" width="100%">
                ...
                <th width="20%">
                    <a class="btn btn-sm btn-outline-warning" href="{{url('/menu' . '/' . $data->id . '/' . 'edit')}}">แก้ไข</a>
