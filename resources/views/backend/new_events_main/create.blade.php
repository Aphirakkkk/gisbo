...
<div class="card cardboby">
    ...
    <div class="card-body">
        <form class="from-horizontal" method="post" enctype="multipart/form-data" action="{{ route('neweventsmain.store') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 ">
                    <input class="form-control inp" type="date" name="date">
                </div>
            </div>
            <div class="form-group row">
                <label for="m" class="col-sm-12 control-label TilteInput">หัวข้อข่าว ภาษาไทย</label>
                <div class="col-sm-12 ">
                    <input type="text" class="form-control" name="tilte_th" placeholder="กรอกหัวข้อข่าว ภาษาไทย" autocomplete="off">
                </div>
            </div>

            <div class="form-group row">
                <label for="m" class="col-sm-12 col-md-12 control-label TilteInput">รายละเอียดหัวข้อข่าว ภาษาไทย</label>
                <div class="col-sm-12 ">
                    <textarea name="detail_th" class="form-control " placeholder="กรอกรายละเอียดหัวข้อข่าว ภาษาไทย"></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="m" class="col-sm-12 control-label TilteInput">หัวข้อข่าว ภาษาอังกฤษ</label>
                <div class="col-sm-12 ">
                    <input type="text" class="form-control" name="tilte_en" placeholder="กรอกหัวข้อข่าว ภาษาอังกฤษ" autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                <label for="m" class="col-sm-12 col-md-12 control-label TilteInput">รายละเอียดหัวข้อข่าว ภาษาอังกฤษ</label>
                <div class="col-sm-12 ">
                    <textarea name="detail_en" class="form-control " placeholder="กรอกรายละเอียดหัวข้อข่าว ภาษาอังกฤษ"></textarea>
                </div>
            </div>


            <div class="form-group row">
                <label for="m" class="col-sm-12 col-md-12 control-label TilteInput">รูปข่าว (รูปหลัก) <span class="text-danger">(ขนาดรูปที่แนะนำควรเป็นขนาด 538px*230px)</span></label>
            ...
            <div class="form-group row">
                <label for="m" class="col-sm-12 col-md-12 control-label TilteInput">รูปข่าว (เพิ่มเติม) <span class="text-danger">(ขนาดรูปที่แนะนำควรเป็นขนาด 700px*400px)</span></label>
                <div class="col-sm-12 col-md-12">
                    <div id="thumbnail_list"></div>
