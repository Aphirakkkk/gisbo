    ...
    <div class="card-body">
        <form class="form-horizontal" method="POST" action="{{ route('aboutus.store') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="tilte_th" placeholder="กรอกหัวข้อ About Us ภาษาไทย" required autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <textarea name="detail_th" class="form-control CreatedDetailTh" placeholder="กรอกรายละเอียด About Us ภาษาไทย"></textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="tilte_en" placeholder="กรอกหัวข้อ About Us ภาษาอังกฤษ" autocomplete="off">
                </div>
            </div>
