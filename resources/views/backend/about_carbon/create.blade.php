...
<div class="card cardboby">
    <div class="card-header bg-transparent border-0">
        <h3 class="mb-0"><i class="fas fa-plus-circle text-success mr-2"></i>สร้างข้อมูล Carbon Footprint</h3>
    </div>
    <div class="card-body">
        <form action="{{ route('aboutuscarbon.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card bg-secondary p-3 mb-4 border-0">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tilte_th" placeholder="กรอกหัวข้อ Carbon Footprint ภาษาไทย" autocomplete="off">
                </div>

                <div class="form-group">
                    <label class="font-weight-bold">รายละเอียด Carbon Footprint ภาษาไทย</label>
                    <textarea name="detail_th" class="form-control CreatedDetailTh" placeholder="กรอกรายละเอียดเนื้อหา Carbon Footprint ภาษาไทย"></textarea>
                </div>
            </div>
            ...
            <div class="card bg-secondary p-3 mb-4 border-0">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tilte_en" placeholder="กรอกหัวข้อ Carbon Footprint ภาษาอังกฤษ" autocomplete="off">
                </div>

                <div class="form-group">
                    <label class="font-weight-bold">รายละเอียด Carbon Footprint ภาษาอังกฤษ</label>
                    <textarea name="detail_en" class="form-control CreatedDetailTh" placeholder="กรอกรายละเอียดเนื้อหา Carbon Footprint ภาษาอังกฤษ"></textarea>
                </div>
            </div>
