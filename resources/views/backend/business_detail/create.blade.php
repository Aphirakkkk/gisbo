...
<div class="card cardboby">
    ...
    <div class="card-body">
        <form class="from-horizontal" method="post" enctype="multipart/form-data" action="{{ route('businessdetail.store') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 ">
                    <textarea name="sub_detail_th" class="form-control CreatedDetailTh" placeholder="กรอกรายละเอียด Business ภาษาไทย"></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="m" class="col-sm-12 control-label TilteInput">คำสโลแกน ภาษาไทย</label>
                <div class="col-sm-12 ">
                    <input type="text" class="form-control" name="slogan_th" placeholder="กรอกคำสโลแกน ภาษาไทย" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 ">
                    <textarea name="sub_detail_en" class="form-control CreatedDetailTh" placeholder="กรอกรายละเอียด Business ภาษาอังกฤษ"></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="m" class="col-sm-12 control-label TilteInput">คำสโลแกน ภาษาอังกฤษ</label>
                <div class="col-sm-12 ">
                    <input type="text" class="form-control" name="slogan_en" placeholder="กรอกคำสโลแกน ภาษาอังกฤษ" autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
