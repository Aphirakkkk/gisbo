...
class CreateWorkAppllcantTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('work_appllcant', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->text('work_id');
            $table->text('appllcant');
    ...
    {
        Schema::dropIfExists('work_appllcant');
    }
}
