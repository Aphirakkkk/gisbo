...
class CreatePortfolioTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('portfolio', function (Blueprint $table) {
            ...
            $table->text('type_portfolio');
            $table->text('tilte_th');
            $table->text('tilte_en');
            $table->text('location_th');
            $table->text('location_en');
            $table->text('project_owner_th');
            $table->text('project_owner_en');
            $table->text('project_value');
            $table->text('project_start');
            $table->text('project_completion');
